		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comsapbankdetails-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapbankdetails-display": {
								"semanticObject": "comsapbankdetails",
								"action": "display",
								"description": "Display My Bank Details",
								"title": "My Bank Details",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.bankdetails",
									"url": sap.ui.require.toUrl("com/sap/bankdetails")
								}
							}
						}
					}
